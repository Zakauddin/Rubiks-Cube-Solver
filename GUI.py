import random as rand  # Add functions that use random -> For mixing
...
def solve2ndCouronne(show=1):  # Solve the second crown
    ...
    liste = ['rg', 'go', 'ob',
             'br']  # Colors of edges by binomial, each letter represents a color, 'rg' means red-green for example
